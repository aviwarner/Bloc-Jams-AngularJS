(function() {
  function SongPlayer($rootScope, Fixtures, AlbumSelector) {
    var SongPlayer = {};
    ...
    */
    ...
    var currentAlbum = Fixtures.getAlbum(albumMarconi);
  ...
  angular
    .module('blocJams')
    .factory('SongPlayer', ['$rootScope','Fixtures','AlbumSelector',SongPlayer]);
})();
